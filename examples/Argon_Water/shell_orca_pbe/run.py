...
if True:
    ...
    sampler = NormalModeScanner(
        ...
        sample_calculator_args = {
            'files': [
                '../templates/shell/run_orca.sh',
                '../templates/shell/run_orca.inp',
                '../templates/shell/run_orca.py',
                ],
            'files_replace': {
                '%xyz%': '$xyz',
                '%charge%': '$charge',
            ...
            'execute_file': 'run_orca.sh',  # or 'templates/shell/run_orca.sh'
            'charge': 1,
            'multiplicity': 2,
            'directory': 'orca_shell',
